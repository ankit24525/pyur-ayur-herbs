...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-center justify-center">
      {/* Glow Pulse Ring */}
      <span className="absolute inline-flex size-14 animate-ping rounded-full bg-[#25d366]/30 opacity-75 duration-1000" />

      <a
        href={whatsappUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="relative z-10 flex size-14 items-center justify-center rounded-full bg-gradient-to-tr from-[#128c7e] to-[#25d366] text-white shadow-xl hover:scale-110 hover:rotate-3 transition-all duration-300 hover:shadow-2xl group"
